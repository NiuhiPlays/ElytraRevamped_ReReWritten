            ...
            return ConfigCategory.createBuilder()
                    ...
                    .group(OptionGroup.createBuilder()
                            ...
                            .option(Option.<Boolean>createBuilder()
                                    ...
                                    .build())
                            .option(Option.<Boolean>createBuilder()
                                    .name(Text.translatable("config.errrw.debug.commands.experimental"))
                                    .description(OptionDescription.of(Text.translatable("config.errrw.debug.commands.experimental.tooltip")))
                                    .available(serverConfigEditable)
