            ...
            return ConfigCategory.createBuilder()
                    ...
                    .group(OptionGroup.createBuilder()
                            ...
                            .option(Option.<Boolean>createBuilder()
                                    ...
                                    .build())
                            .option(Option.<Boolean>createBuilder()
                                    .name(Text.translatable("config.errrw.elytra.enableBounce.experimental"))
                                    .description(OptionDescription.of(Text.translatable("config.errrw.elytra.enableBounce.experimental.tooltip")))
                                    .available(serverConfigEditable)
